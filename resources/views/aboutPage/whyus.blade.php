{{--  <section class="bg-cover bg-fixed py-2 bg-center-top mt-10">
    <div class="max-w-4xl mx-auto my-24 p-20 service_cont_sub">
        <h1 class="uppercase font-extrabold text-3xl mb-5">why choose us</h1>
        <p class="text-lg font-medium mb-30 leading-tight">Officia culpa aliquip pariatur tempor deserunt mollit
            exercitation esse. Occaecat eu excepteur enim consequat
            laborum enim magna.</p>

        <div class="w-full my-6">
            <div class="h-1 bg-yellow-600 w-24 opacity-75 my-0 py-0 rounded-t"></div>
        </div>

        <div class="flex mb-8 mx-auto">
            <img src="images/icon/correct.svg" alt=""
                class="h-16 w-16 rounded-full border border-yellow-600 my-auto p-2">

            <div class="ml-5">
                <h2 class="font-bold text-lg font-serif leading-tight mb-1">Easy Booking</h2>
                <p class="text-base leading-relaxed font-sans w-auto font-sans">Et anim officia id aliqua nulla dolor
                    nulla
                    proident fugiat elit amet voluptate. Ea culpa elit qui laboris ad exercitation do cupidatat aliqua
                    et. Veniam tempor voluptate consectetur et nulla adipisicing exercitation officia ea est ullamco
                    excepteur.</p>
            </div>
        </div>
        ...
        <div class="flex mb-8 mx-auto">
            ...
            <div class="ml-5">
                <h2 class="font-bold text-lg font-serif leading-tight mb-1">24/7 Customer Service</h2>
                <p class="text-base leading-relaxed font-sans w-auto font-sans">Et anim officia id aliqua nulla dolor
                    nulla
                    proident fugiat elit amet voluptate. Ea culpa elit qui laboris ad exercitation do cupidatat aliqua
                    et. Veniam tempor voluptate consectetur et nulla adipisicing exercitation officia ea est ullamco
        ...
        <div class="flex mb-8 mx-auto">
            <img src="images/icon/wallet.svg" alt=""
                class="h-16 w-16 rounded-full border border-yellow-600 my-auto p-2">
            <div class="ml-5">
                <h2 class="font-bold text-lg font-serif leading-tight mb-1">Best Price Guaranteed</h2>
                <p class="text-base leading-relaxed font-sans w-auto font-sans">Et anim officia id aliqua nulla dolor
                    nulla
                    proident fugiat elit amet voluptate. Ea culpa elit qui laboris ad exercitation do cupidatat aliqua
                    et. Veniam tempor voluptate consectetur et nulla adipisicing exercitation officia ea est ullamco
        ...
        <div class="flex mb-8 mx-auto">
            ...
            <div class="ml-5">
                <h2 class="font-bold text-lg font-serif leading-tight mb-1">Customer Satisfaction</h2>
                <p class="text-base leading-relaxed font-sans w-auto font-sans">Et anim officia id aliqua nulla dolor
                    nulla
                    proident fugiat elit amet voluptate. Ea culpa elit qui laboris ad exercitation do cupidatat aliqua
                    et. Veniam tempor voluptate consectetur et nulla adipisicing exercitation officia ea est ullamco
        ...
        <div class="flex mb-8 mx-auto">
            ...
            <div class="ml-5">
                <h2 class="font-bold text-lg font-serif leading-tight mb-1">Compliance Solution</h2>
                <p class="text-base leading-relaxed font-sans w-auto font-sans">Et anim officia id aliqua nulla dolor
                    nulla
                    proident fugiat elit amet voluptate. Ea culpa elit qui laboris ad exercitation do cupidatat aliqua
                    et. Veniam tempor voluptate consectetur et nulla adipisicing exercitation officia ea est ullamco
...
<section class="bg-white border-b py-8">
    ...
    <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow text-center">
                <div class="flex flex-wrap no-underline hover:no-underline">
                    <svg class="h-32 w-32 my-auto p-2 mx-auto" id="a50fd755-b70f-4e5f-b336-9e50a578b62c"
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow text-center">
                <div class="flex flex-wrap no-underline hover:no-underline">
                    <svg class="h-32 w-32 my-auto p-2 mx-auto" id="baed4b18-14ee-447f-bd84-b0265ca0ad8a"
                        data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow text-center">
                <div class="flex flex-wrap no-underline hover:no-underline">
                    ...
                    <svg class="h-32 w-32 my-auto p-2 mx-auto" id="ae37f038-3a9e-4b82-ad68-fc94ba16af2a"
                        data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow text-center">
                <div class="flex flex-wrap no-underline hover:no-underline">
                    <svg class="h-32 w-32 my-auto p-2 mx-auto" id="af42373d-99da-4b97-8953-6caa05385f1a"
                        data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path
                            ...
                            transform="translate(-31.44 -37.71)" fill="url(#38e3d8fd-16c6-494d-bdf0-b7b543d88498)" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-31.44 -37.71)" fill="#4d507f" />
                        <path d="M931.46,354.55s-26.8-2.08-27.75,11.75,1.41,24.48,21.93,26.17,13.12-37.65,13.12-37.65Z"
                            transform="translate(-31.44 -37.71)" fill="#575a89" />
                        <path d="M981.06,361.49s26.29-4.1,26.1,6.14-20.07,23.55-20.07,23.55Z"
                            transform="translate(-31.44 -37.71)" fill="#575a89" />
                        <path d="M932.45,354.55s-26.79-2.08-27.74,11.75,1.4,24.48,21.92,26.17,13.13-37.65,13.13-37.65Z"
                        ...
                        <path d="M297.43,534.15s17.45,11.76,11.9,29.43" transform="translate(-31.44 -37.71)" fill="none"
                            stroke="#565987" stroke-miterlimit="10" />
                        <path d="M358.73,544.62s-10.67-10.85-23.65-4.87" transform="translate(-31.44 -37.71)"
                            fill="none" stroke="#565987" stroke-miterlimit="10" />
                        <path d="M308.64,599.19s-18.73-9.51-23.57,2.4" transform="translate(-31.44 -37.71)" fill="none"
                            stroke="#565987" stroke-miterlimit="10" />
                        ...
                        <path
                            ...
                            transform="translate(-31.44 -37.71)" fill="#6c63ff" />
                        <path d="M335.2,649.65s-52.85,76.63-63.06,80" transform="translate(-31.44 -37.71)" fill="none"
                            stroke="#565987" stroke-miterlimit="10" />
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow text-center">
                <div class="flex flex-wrap no-underline hover:no-underline">
                    <svg class="h-32 w-32 my-auto p-2 mx-auto" id="629dcec7-c063-4496-b40c-d8a33d01e794"
                        data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="873.56" height="795" viewBox="0 0 873.56 795">
                        <defs>
                            <linearGradient id="1ad885a6-086f-4584-b8fc-49709722d9e2" x1="441" y1="598" x2="441" y2="55"
                            ...
                            <linearGradient id="e2b55b91-c252-4605-a1d1-0f99b0ab4047" x1="308.78" y1="389.5" x2="308.78"
                                y2="307.5" xlink:href="#1ad885a6-086f-4584-b8fc-49709722d9e2" />
                            <linearGradient id="76544af5-6047-4a4c-b2fc-a23f66c9d65b" x1="309.06" y1="550" x2="309.06"
                                y2="468" xlink:href="#1ad885a6-086f-4584-b8fc-49709722d9e2" />
                            <linearGradient id="daf008b2-47be-48c6-a376-1f125493a331" x1="308.5" y1="205.63" x2="308.5"
                                y2="165.37" xlink:href="#1ad885a6-086f-4584-b8fc-49709722d9e2" />
                        ...
                        <path
                            ...
                            transform="translate(-163.22 -52.5)" fill="url(#4923b0dd-8e96-4c93-b583-a6b0ce88de70)" />
