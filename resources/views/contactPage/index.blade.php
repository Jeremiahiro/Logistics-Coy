...
<div class="container p-4 md:px-0 max-w-6xl mx-auto -mt-40 mb-10 rounded-lg bg-black-300 w-full bg-gray-900 relative">
            ...
            <div class="flex flex-1 justify-end content-center">
                <div class="flex w-1/2 justify-end content-center">
                    ...
                    <a href="/twitter.com/sevenstarlog" class="mr-12">
                        <img src="images/icon/instagram.svg" alt="" class="h-8 inline-block">
                    </a>
                </div>
            </div>
        </div>
