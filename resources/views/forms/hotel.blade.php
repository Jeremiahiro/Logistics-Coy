<form class="w-full mx-auto py-8 px-4 relative">
    ...
    <div class="flex flex-wrap mb-5 text-sm">
        <div class="w-full md:w-1/5 px-1 mb-6 md:mb-0">
            <label class="block text-gray-700 font-bold mb-2 text-sm tracking-wide uppercase ml-5" for="destination_hotel">
                Destination
            </label>
            <div class="flex flex-row">
                <div class="inline-block relative w-full">
                    <input
                        ...
                        id="destination_hotel" type="number" placeholder="e.g City or Hotel Name">
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center px-2 text-gray-700">
                        <img src="images/icon/destination.svg" alt="" class="inline-block h-8">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/5 px-1 mb-6 md:mb-0">
            ...
            <div class="flex flex-row">
                <div class="inline-block relative w-full">
                    ...
                    <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center px-2 text-gray-700">
                        <img src="images/icon/bed.svg" alt="" class="inline-block h-8">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full md:w-1/5 px-1 mb-6 md:mb-0">
            ...
            <div class="inline-block relative w-full">
                <input
                    ...
                    id="check_in" type="date" placeholder="" name="departure_date">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center px-2 text-gray-700">
        ...
        <div class="w-full md:w-1/5 px-1 mb-6 md:mb-0" id="return_date">
            ...
            <div class="inline-block relative w-full">
                <input
                    class="shadow appearance-none border rounded w-full py-3 px-4 pl-12 bg-gray-200 text-lg text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="check_out" type="date" placeholder="">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center px-2 text-gray-700">
                    <img src="images/icon/calendar.svg" alt="" class="inline-block h-8">
                </div>
            </div>
        ...
        <div class="flex-1">
            <div class="w-full mx-auto px-3 my-4 md:mb-0 text-center max-w-xs">
                <button
                    class="w-full bg-yellow-600 text-white py-2 px-4 mt-3 border-solid border-4 font-bold text-xl rounded-lg leading-tight border-yellow-600 shadow-lg hover:bg-transparent hover:text-orange-600 hover:text-2xl">
                    Search
                </button>
            </div>
        </div>
