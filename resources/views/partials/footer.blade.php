<footer class="bg-gray-900">
                ...
                <div class="lg:w-2/6 lg:mb-0 mb-8">
                    <div class="md:container text-center md:mx-auto lg:text-left">
                        ...
                        <p class="mt-2 mr-2 md:mr-0 text-gray-500">
                            ...
                            <br>
                            <a href="#"
                                class="no-underline hover:text-yellow-600 hover:underline hover:text-yellow-600">logistics.sevenstar@yahoo.com</a>
                        </p>
                    </div>
                </div>
    ...
    <div class="bg-black-100 w-full text-gray-600 p-3 text-center">
        ...
        <button class="float-right w-6 -mt-4 lg-mt-2 footer_icon" onclick="topFunction()" title="Scroll to Top">
