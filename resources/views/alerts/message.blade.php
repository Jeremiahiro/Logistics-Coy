...
@if (session('success'))
<div class="alert-toast fixed top-0 right-0 mt-20 w-5/6 md:w-full max-w-sm">
    <input type="checkbox" class="hidden" id="successtoast">
    <label class="close cursor-pointer flex items-start justify-between w-full bg-green-200 border-l-4 border-green-500 text-green-700 p-4" title="close" for="successtoast">
...
@if (session('error'))
<div class="alert-toast fixed top-0 right-0 mt-20 w-5/6 md:w-full max-w-sm">
    <input type="checkbox" class="hidden" id="errortoast">
    <label class="close cursor-pointer flex items-start justify-between w-full bg-red-100 border-l-4 border-red-500 text-red-700 p-4" title="close" for="errortoast">
...
<div class="alert-toast fixed top-0 right-0 mt-20 w-5/6 md:w-full max-w-sm">
    ...
    <label class="close cursor-pointer flex items-start justify-between w-full bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4" title="close" for="statustoast">
      ...
      <svg class="fill-current text-yellow-700" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
        <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z"></path>
      </svg>
    </label>
</div>
